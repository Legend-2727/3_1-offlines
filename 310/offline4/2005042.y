...
%token <symbolInfo> IF FOR WHILE RETURN PRINTLN SWITCH CASE BREAK DEFAULT COLON
...
unit : var_declaration{
     ...
     ;
switch_case_definition  : SWITCH LPAREN expression RPAREN LCURL case_handle RCURL{
...
case_handle :case_handle CASE CONST_INT  COLON statements SEMICOLON BREAK SEMICOLON{
...
|case_handle CASE CONST_INT  COLON statements SEMICOLON BREAK SEMICOLON default_part{
	SymbolInfo *temp=new SymbolInfo("Node","case_handle");
	...
	printInLog(temp->getRule());
				...
				| CASE CONST_INT  COLON statements SEMICOLON BREAK SEMICOLON{
	SymbolInfo *temp=new SymbolInfo("Node","case_handle");
...
default_part: DEFAULT COLON statements SEMICOLON BREAK SEMICOLON{
	SymbolInfo *temp=new SymbolInfo("Node","case_handle");
...
declaration_list : declaration_list COMMA ID{
 		  ...
 		  | ID LTHIRD CONST_INT RTHIRD{
				...
				temp->setIsArray();
				//cout<<$3->getName()<<"he\n";
				temp->setArraySize(stoi($3->getName()));
